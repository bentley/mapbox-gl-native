...
const std::map<PropertyKey, PropertyValue> PropertyFallbackValue::properties = {
    ...
    { PropertyKey::FillVisibility, defaultLayoutProperties<StyleBucketFill>().visibility },
    ...
    { PropertyKey::LineVisibility, defaultLayoutProperties<StyleBucketLine>().visibility },
    ...
    { PropertyKey::SymbolVisibility, defaultLayoutProperties<StyleBucketSymbol>().visibility },
    ...
    { PropertyKey::RasterVisibility, defaultLayoutProperties<StyleBucketRaster>().visibility },

    { PropertyKey::BackgroundVisibility, defaultLayoutProperties<StyleBucketBackground>().visibility },
};
