...
public:
    ...
    void updateProperties(float z);

private:
    bool obsolete() const;
    void parseStyleLayers(util::ptr<StyleLayerGroup> group, float z);
    ...
    std::unique_ptr<Bucket> createBucket(util::ptr<StyleBucket> bucket_desc, float z);
